  ...
  return (
    <>
      <SEO 
        ...
        description={t('handling.subtitle')}
      />
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">{t('handling.title')}</h1>
        ...
        <Modal
          ...
          title={t('handling.form.title.new')}
        >
          <WorkOrderForm
